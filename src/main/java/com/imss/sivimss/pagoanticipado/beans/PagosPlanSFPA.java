        ...
        public String obtenerDetalleBitacoraPago() {
                ...
                selectQueryUtil
                                .select("SBPA.ID_BITACORA_PAGO AS idBitacora",
                                                ...
                                                "CASE WHEN SBPA.REF_FOLIO_AUTORIZACION IS NOT NULL\r\n"
                                                ...
                                                "(" + selectQueryUtilPrimerParcialidad.build()
                                                                + ") AS idPrimerParcialidad",
                                                "(" + selectQueryUtilUltimaParcialidad.build()
                                                                + ") AS idUltimaParcialidad")
                                ...
                                .innerJoin("SVC_ESTATUS_PAGO_ANTICIPADO SPA",
