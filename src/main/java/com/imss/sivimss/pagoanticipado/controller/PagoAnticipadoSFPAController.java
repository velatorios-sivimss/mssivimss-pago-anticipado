...
public class PagoAnticipadoSFPAController {
        ...
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory
                        .getLogger(PagoAnticipadoSFPAController.class);

        @CircuitBreaker(name = "msflujo", fallbackMethod = "fallbackGenerico")
        @Retry(name = "msflujo", fallbackMethod = "fallbackGenerico")
        @TimeLimiter(name = "msflujo")
        @PostMapping("buscar-planes")
        public CompletableFuture<?> buscarPlanSFPA(@RequestBody DatosRequest request, Authentication authentication)
        ...
        public CompletableFuture<?> buscarPlanSFPAFolio(@RequestBody DatosRequest request,
        ...
        public CompletableFuture<?> obtenerMetodosPago(@RequestBody DatosRequest request, Authentication authentication)
                        throws IOException, ParseException {
        ...
        public CompletableFuture<?> obtenerDetalle(@RequestBody DatosRequest request, Authentication authentication)
                        throws IOException, ParseException, SQLException {
        ...
        public CompletableFuture<?> generarPDF(@RequestBody DatosRequest request, Authentication authentication)
                        throws IOException, ParseException {
        ...
        public CompletableFuture<?> descargarReportePa(@RequestBody DatosRequest request, Authentication authentication)
                        throws IOException, ParseException {
        ...
        @Retry(name = "msflujo", fallbackMethod = "fallbackGenerico")
        @TimeLimiter(name = "msflujo")
        @PostMapping("descargar-pagos-parcialidades-pdf")
        public CompletableFuture<?> generarPagosParcialidadesPDF(@RequestBody DatosRequest request, Authentication authentication)
                        throws IOException, ParseException {
                Response<?> response = servicio.descargarReportePagosParcialidades(request, authentication);
                return CompletableFuture
                                .supplyAsync(() -> new ResponseEntity<>(response,
                                                HttpStatus.valueOf(response.getCodigo())));
        }
